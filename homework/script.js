...
newGame.addEventListener("click", () => {
  ...
  console.log(randomNum);
  // inputNum.setAttribute("style", "animation: outline 2s linear infinite alternate;");
});
...
btn.addEventListener("click", () => {
  ...
  if (randomNum == userNum) {
    ...
    inputNum.setAttribute("style", "animation: success 2s linear 5 alternate !important");
  } else if (userNum > 10) {
    rightAns.setAttribute("style", "background: #ff0f0f");
    rightAns.textContent = "Please, Enter a number less than 11";
    inputNum.setAttribute("style", "animation: errorans 2s linear 5 alternate !important");
  } else if (userNum <= 0) {
    rightAns.setAttribute("style", "background: #ff0f0f");
